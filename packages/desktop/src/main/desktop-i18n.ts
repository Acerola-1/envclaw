...
type TranslationKey =
  ...
  | 'desktop.downloadMirrorTitle'
  | 'desktop.downloadMirrorDetail'
...
const translations: Record<DesktopLocale, Record<TranslationKey, string>> = {
  en: {
    'tray.show': 'Show Envclaw',
    'tray.hide': 'Hide Envclaw',
    'tray.checkForUpdates': 'Check for Updates',
    'tray.openAtLogin': 'Open at Login',
    'tray.quit': 'Quit Envclaw',
    'update.upToDateTitle': 'Envclaw',
    'update.upToDateMessage': 'Envclaw is up to date.',
    'update.checkingTitle': 'Envclaw',
    ...
    'update.availableMessage': 'Envclaw {version} is available.',
    'update.downloading': 'The update is downloading in the background.',
    'update.readyTitle': 'Update ready',
    'update.readyMessage': 'Envclaw {version} is ready to install.',
    ...
    'desktop.downloadGithubDetail': 'Fetch from GitHub Releases via a China-friendly proxy. Use if the mirror is unavailable.',
    'desktop.downloadMirrorTitle': 'Download from Mirror',
    'desktop.downloadMirrorDetail': 'Download from the official mirror server. Recommended for users in China.',
  ...
  zh: {
    ...
    'desktop.downloadGithubDetail': '通过国内代理从 GitHub Release 拉取，镜像不可用时使用。',
    'desktop.downloadMirrorTitle': '从镜像下载',
    'desktop.downloadMirrorDetail': '从官方镜像服务器下载，国内用户推荐。',
  ...
  'zh-TW': {
    'tray.show': '顯示 Envclaw',
    'tray.hide': '隱藏 Envclaw',
    'tray.checkForUpdates': '檢查更新',
    'tray.openAtLogin': '開機啟動',
    'tray.quit': '結束 Envclaw',
    'update.upToDateTitle': 'Envclaw',
    'update.upToDateMessage': 'Envclaw 已是最新版本。',
    'update.checkingTitle': 'Envclaw',
    ...
    'update.readyMessage': 'Envclaw {version} 已準備好安裝。',
    ...
    'desktop.downloadGithubDetail': '透過國內代理從 GitHub Release 拉取，鏡像不可用時使用。',
    'desktop.downloadMirrorTitle': '從鏡像下載',
    'desktop.downloadMirrorDetail': '從官方鏡像伺服器下載，國內使用者推薦。',
  ...
  ja: {
    ...
    'desktop.downloadGithubDetail': 'GitHub Release から中国向けプロキシ経由で取得します。ミラーが利用できない場合に使用してください。',
    'desktop.downloadMirrorTitle': 'ミラーからダウンロード',
    'desktop.downloadMirrorDetail': '公式ミラーサーバーからダウンロードします。中国国内のユーザーにおすすめ。',
  ...
  ko: {
    ...
    'desktop.downloadGithubDetail': '중국 친화적 프록시를 통해 GitHub Release에서 가져옵니다. 미러를 사용할 수 없을 때 사용하세요.',
    'desktop.downloadMirrorTitle': '미러에서 다운로드',
    'desktop.downloadMirrorDetail': '공식 미러 서버에서 다운로드합니다. 중국 내 사용자에게 권장됩니다.',
  ...
  fr: {
    'tray.show': 'Afficher Envclaw',
    'tray.hide': 'Masquer Envclaw',
    'tray.checkForUpdates': 'Rechercher les mises a jour',
    'tray.openAtLogin': 'Ouvrir a la connexion',
    'tray.quit': 'Quitter Envclaw',
    'update.upToDateTitle': 'Envclaw',
    'update.upToDateMessage': 'Envclaw est a jour.',
    'update.checkingTitle': 'Envclaw',
    ...
    'update.availableMessage': 'Envclaw {version} est disponible.',
    'update.downloading': 'La mise a jour se telecharge en arriere-plan.',
    'update.readyTitle': 'Mise a jour prete',
    'update.readyMessage': 'Envclaw {version} est pret a etre installe.',
    ...
    'desktop.downloadGithubDetail': 'Recupere depuis GitHub Releases via un proxy adapte a la Chine. A utiliser si le miroir est indisponible.',
    'desktop.downloadMirrorTitle': 'Telecharger depuis le miroir',
    'desktop.downloadMirrorDetail': 'Telecharge depuis le serveur miroir officiel. Recommande pour les utilisateurs en Chine.',
  ...
  es: {
    'tray.show': 'Mostrar Envclaw',
    'tray.hide': 'Ocultar Envclaw',
    'tray.checkForUpdates': 'Buscar actualizaciones',
    'tray.openAtLogin': 'Abrir al iniciar sesion',
    'tray.quit': 'Salir de Envclaw',
    'update.upToDateTitle': 'Envclaw',
    'update.upToDateMessage': 'Envclaw esta actualizado.',
    'update.checkingTitle': 'Envclaw',
    ...
    'update.availableMessage': 'Envclaw {version} esta disponible.',
    'update.downloading': 'La actualizacion se esta descargando en segundo plano.',
    'update.readyTitle': 'Actualizacion lista',
    'update.readyMessage': 'Envclaw {version} esta listo para instalarse.',
    ...
    'desktop.downloadGithubDetail': 'Obtenido desde GitHub Releases mediante un proxy compatible con China. Usar si el espejo no esta disponible.',
    'desktop.downloadMirrorTitle': 'Descargar desde espejo',
    'desktop.downloadMirrorDetail': 'Descarga desde el servidor espejo oficial. Recomendado para usuarios en China.',
  ...
  de: {
    'tray.show': 'Envclaw anzeigen',
    'tray.hide': 'Envclaw ausblenden',
    'tray.checkForUpdates': 'Nach Updates suchen',
    'tray.openAtLogin': 'Beim Anmelden offnen',
    'tray.quit': 'Envclaw beenden',
    'update.upToDateTitle': 'Envclaw',
    'update.upToDateMessage': 'Envclaw ist auf dem neuesten Stand.',
    'update.checkingTitle': 'Envclaw',
    ...
    'update.availableMessage': 'Envclaw {version} ist verfugbar.',
    'update.downloading': 'Das Update wird im Hintergrund heruntergeladen.',
    'update.readyTitle': 'Update bereit',
    'update.readyMessage': 'Envclaw {version} ist zur Installation bereit.',
    ...
    'desktop.downloadGithubDetail': 'Uber einen China-kompatiblen Proxy von GitHub Releases beziehen. Verwenden, wenn der Spiegel nicht verfugbar ist.',
    'desktop.downloadMirrorTitle': 'Vom Spiegel herunterladen',
    'desktop.downloadMirrorDetail': 'Vom offiziellen Spiegelserver herunterladen. Empfohlen fur Benutzer in China.',
  ...
  pt: {
    ...
    'tray.quit': 'Sair do Envclaw',
    'update.upToDateTitle': 'Envclaw',
    'update.upToDateMessage': 'Envclaw esta atualizado.',
    'update.checkingTitle': 'Envclaw',
    ...
    'update.availableMessage': 'Envclaw {version} esta disponivel.',
    'update.downloading': 'A atualizacao esta sendo baixada em segundo plano.',
    'update.readyTitle': 'Atualizacao pronta',
    'update.readyMessage': 'Envclaw {version} esta pronto para instalar.',
    ...
    'desktop.downloadGithubTitle': 'Baixar do GitHub',
    'desktop.downloadGithubDetail': 'Obtido via GitHub Releases atraves de um proxy compativel com a China. Use se o espelho estiver indisponivel.',
    'desktop.downloadMirrorTitle': 'Baixar do espelho',
    'desktop.downloadMirrorDetail': 'Baixa do servidor espelho oficial. Recomendado para usuarios na China.',
