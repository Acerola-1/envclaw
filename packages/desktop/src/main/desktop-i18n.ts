...
const translations: Record<DesktopLocale, Record<TranslationKey, string>> = {
  en: {
    ...
    'desktop.downloadGithubTitle': 'Download runtime',
    'desktop.downloadGithubDetail': 'Fetched from GitHub Releases via a China-friendly proxy by default.',
  ...
  zh: {
    ...
    'desktop.downloadGithubTitle': '下载运行时',
    'desktop.downloadGithubDetail': '默认通过国内代理从 GitHub Release 拉取。',
  ...
  'zh-TW': {
    ...
    'desktop.downloadGithubTitle': '下載運行時',
    'desktop.downloadGithubDetail': '預設透過國內代理從 GitHub Release 拉取。',
  ...
  ja: {
    ...
    'desktop.downloadGithubTitle': 'ランタイムをダウンロード',
    'desktop.downloadGithubDetail': 'GitHub Release から、デフォルトでは中国向けプロキシ経由で取得します。',
  ...
  ko: {
    ...
    'desktop.downloadGithubTitle': '런타임 다운로드',
    'desktop.downloadGithubDetail': '기본적으로 중국 친화적 프록시를 통해 GitHub Release에서 가져옵니다.',
  ...
  fr: {
    ...
    'desktop.downloadGithubTitle': 'Telecharger le runtime',
    'desktop.downloadGithubDetail': 'Recupere depuis GitHub Releases via un proxy adapte a la Chine par defaut.',
  ...
  es: {
    ...
    'desktop.downloadGithubTitle': 'Descargar runtime',
    'desktop.downloadGithubDetail': 'Obtenido desde GitHub Releases mediante un proxy compatible con China por defecto.',
  ...
  de: {
    ...
    'desktop.downloadGithubTitle': 'Runtime herunterladen',
    'desktop.downloadGithubDetail': 'Wird standardmassig uber einen China-kompatiblen Proxy von GitHub Releases bezogen.',
  ...
  pt: {
    ...
    'desktop.downloadGithubTitle': 'Baixar runtime',
    'desktop.downloadGithubDetail': 'Obtido via GitHub Releases atraves de um proxy compativel com a China por padrao.',
