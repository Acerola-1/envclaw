...
contextBridge.exposeInMainWorld('hermesDesktop', {
  ...
  retryBootstrap: (source?: 'github'): Promise<void> => ipcRenderer.invoke('hermes-desktop:retry-bootstrap', source),
  ...
  selectFolder: (title?: string): Promise<string | null> => ipcRenderer.invoke('hermes-desktop:select-folder', title),
...
// Desktop no longer auto-logs in with default credentials.
// Users must manually log in via the LoginView (same as web),
// so the login account is always explicit and traceable.
