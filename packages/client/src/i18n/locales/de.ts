export default {
  ...
  chat: {
    ...
    cancelReference: 'Zitat abbrechen',
  ...
  jobs: {
    ...
    sortByTimeHint: 'Nach Zeit sortieren',
    sortAsc: 'Aufsteigend',
    sortDesc: 'Absteigend',
    ...
    scheduleCustom: 'Benutzerdefiniert',
    scheduleCustomCron: 'Benutzerdefiniertes Cron',
    scheduleCronFormat: 'Format: Minute Stunde Tag Monat Wochentag',
    scheduleEveryNHoursAtMinute: 'Alle {n} Stunden um {minute} Minuten',
    scheduleMinuteOffset: 'Minutenoffset',
...
jobTriggered: 'Job ausgelost',
  ...
  models: {
    ...
    editProviderTitle: '{name} bearbeiten',
    providerEditorLoadFailed: 'Provider-Einstellungen konnten nicht geladen werden',
    providerEditorSaved: 'Provider-Einstellungen gespeichert',
    providerEditorSaveFailed: 'Provider-Einstellungen konnten nicht gespeichert werden',
    providerEditorConflict: 'Dieser Provider wurde anderweitig geändert. Die neuesten Einstellungen wurden neu geladen.',
    providerEditorRequired: 'Anzeigename, Base-URL und bevorzugtes Modell sind erforderlich.',
    providerInternalId: 'Interne Provider-ID',
    providerDisplayName: 'Anzeigename',
    providerIdStableHint: 'Die interne Provider-ID bleibt unverändert, damit bestehende Verweise gültig bleiben.',
    providerPreferredModel: 'Bevorzugtes Provider-Modell',
    providerPreferredModelHint: 'Dies ändert nicht das profilweite Standardmodell.',
    selectOrEnterModel: 'Modell-ID auswählen oder eingeben...',
    unverifiedModelWarning: 'Dieses Modell ist nicht im aktuellen Katalog und wurde nicht verifiziert.',
    credentialConfigured: 'Konfiguriert',
    credentialNotConfigured: 'Nicht konfiguriert',
    leaveBlankKeepCredential: 'Leer lassen, um den aktuellen Schlüssel zu behalten',
    enterCredential: 'Provider-Zugangsdaten eingeben',
    credentialNeverDisplayedHint: 'Der gespeicherte Schlüssel wird nie angezeigt. Geben Sie nur einen neuen Wert ein, um ihn zu ersetzen.',
    providerCredentialMissingHint: 'Dieser Provider ist nicht verfügbar, bis Zugangsdaten konfiguriert sind.',
    providerAdvancedSettings: 'Erweiterte Provider-Einstellungen',
    discoverModels: 'Modelle vom Provider ermitteln',
    rateLimitDelay: 'Ratenbegrenzungs-Verzögerung (Sekunden)',
    requestTimeoutSeconds: 'Anfrage-Timeout (Sekunden)',
    staleTimeoutSeconds: 'Timeout für veraltete Anfragen (Sekunden)',
    extraBodyHint: 'Optionales JSON-Objekt, das in Provider-Anfragen eingefügt wird. Leer lassen, um es zu entfernen.',
    extraBodyInvalid: 'extra_body muss ein gültiges JSON-Objekt sein.',
    providerTestUnsupported: 'Verbindungstest wird für diesen API-Modus nicht unterstützt.',
    perModelContextLengths: 'Kontextlängen pro Modell',
    contextLengthInheritHint: 'Wert löschen, um den Provider- oder Systemstandard zu übernehmen.',
    inheritDefault: 'Standard übernehmen',
    providerReconnectHint: 'Änderungen gelten für neue Läufe. Bestehende Chat- oder Coding-Agent-Sitzungen müssen sich neu verbinden.',
    testConnection: 'Verbindung testen',
    providerTestSuccess: 'Verbindung erfolgreich; {count} Modelle gefunden',
    providerTestFailed: 'Provider-Verbindungstest fehlgeschlagen',
    providerTestFailedTitle: 'Verbindungstest fehlgeschlagen',
    providerSaveAnywayHint: 'Sie können diese Einstellungen dennoch ausdrücklich speichern, aber der Provider ist möglicherweise nicht verfügbar.',
    saveAnyway: 'Trotzdem speichern',
    providerCredentialsCleared: 'Provider-Zugangsdaten gelöscht',
    clearProviderCredentials: 'Zugangsdaten löschen',
    clearCredentialsConfirm: 'Gespeicherte Anmeldedaten für „{name}“ löschen? Dieser integrierte Provider bleibt aufgelistet und kann nach dem Konfigurieren von Anmeldedaten wieder verwendet werden.',
  ...
  files: {
    ...
    htmlPreviewTitle: 'Isolierte HTML-Vorschau',
    previewMode: 'Vorschau',
    sourceMode: 'Quelltext',
    tableMode: 'Tabelle',
