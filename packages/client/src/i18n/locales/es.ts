export default {
  ...
  runtimeVersions: {
    ...
    activateSuccess: 'Selección de versión guardada. Reinicia Envclaw para usarla.',
    jobStatus: {
      queued: 'En cola',
...
jobTriggered: 'Job ejecutado',
  ...
  models: {
    ...
    providerEditorLoadFailed: 'No se pudieron cargar los ajustes del proveedor',
    providerEditorSaved: 'Ajustes del proveedor guardados',
    providerEditorSaveFailed: 'No se pudieron guardar los ajustes del proveedor',
    providerEditorConflict: 'Este proveedor cambió en otro lugar. Se han recargado los ajustes más recientes.',
    providerEditorRequired: 'El nombre visible, la Base URL y el modelo preferido son obligatorios.',
    providerInternalId: 'ID interno del proveedor',
    providerDisplayName: 'Nombre visible',
    providerIdStableHint: 'El ID interno del proveedor permanece sin cambios para que las referencias existentes sigan siendo válidas.',
    providerPreferredModel: 'Modelo preferido del proveedor',
    providerPreferredModelHint: 'Esto no cambia el modelo predeterminado de todo el perfil.',
    selectOrEnterModel: 'Selecciona o introduce un ID de modelo...',
    unverifiedModelWarning: 'Este modelo no está en el catálogo actual y no ha sido verificado.',
    credentialConfigured: 'Configurado',
    credentialNotConfigured: 'No configurado',
    leaveBlankKeepCredential: 'Déjalo en blanco para mantener la clave actual',
    enterCredential: 'Introduce la credencial del proveedor',
    credentialNeverDisplayedHint: 'La clave guardada nunca se muestra. Introduce un nuevo valor solo para reemplazarla.',
    providerCredentialMissingHint: 'Este proveedor no está disponible hasta que se configure una credencial.',
    providerAdvancedSettings: 'Ajustes avanzados del proveedor',
    discoverModels: 'Descubrir modelos desde el proveedor',
    rateLimitDelay: 'Retardo por límite de tasa (segundos)',
    requestTimeoutSeconds: 'Tiempo de espera de solicitud (segundos)',
    staleTimeoutSeconds: 'Tiempo de espera de solicitudes obsoletas (segundos)',
    extraBodyHint: 'Objeto JSON opcional que se fusiona en las solicitudes del proveedor. Déjalo en blanco para eliminarlo.',
    extraBodyInvalid: 'extra_body debe ser un objeto JSON válido.',
    providerTestUnsupported: 'La prueba de conexión no es compatible con este modo de API.',
    perModelContextLengths: 'Longitudes de contexto por modelo',
    contextLengthInheritHint: 'Borra un valor para heredar el valor predeterminado del proveedor o del sistema.',
    inheritDefault: 'Heredar predeterminado',
    providerReconnectHint: 'Los cambios se aplican a nuevas ejecuciones. Las sesiones de chat o de agente de código existentes deben reconectarse.',
    testConnection: 'Probar conexión',
    providerTestSuccess: 'Conexión exitosa; {count} modelos encontrados',
    providerTestFailed: 'La prueba de conexión del proveedor falló',
    providerTestFailedTitle: 'La prueba de conexión falló',
    providerSaveAnywayHint: 'Aún puedes guardar estos ajustes explícitamente, pero el proveedor puede no estar disponible.',
    ...
    clearCredentialsConfirm: '¿Borrar las credenciales guardadas de «{name}»? Este proveedor integrado seguirá en la lista y podrá usarse de nuevo tras configurar las credenciales.',
  ...
  files: {
    ...
    previewFailed: 'Vista previa no disponible',
    pdfPageLimit: 'Solo se muestran las primeras {count} páginas.',
    htmlPreviewTitle: 'Vista previa HTML aislada',
    previewMode: 'Vista previa',
    sourceMode: 'Código fuente',
    tableMode: 'Tabla',
    worksheet: 'Hoja',
