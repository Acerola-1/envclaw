export default {
  ...
  runtimeVersions: {
    ...
    activateSuccess: 'Seleção de versão salva. Reinicie o Envclaw para usá-la.',
    jobStatus: {
      queued: 'Na fila',
      running: 'Em execução',
      completed: 'Concluída',
  ...
  jobs: {
    ...
    sortByTimeHint: 'Ordenar por hora',
    sortAsc: 'Crescente',
    ...
    scheduleCustomCron: 'Cron personalizado',
    scheduleCronFormat: 'Formato: minuto hora dia mês dia_semana',
    scheduleEveryNHoursAtMinute: 'A cada {n} horas aos {minute} min',
    scheduleMinuteOffset: 'Minuto de deslocamento',
...
jobTriggered: 'Job acionado',
  ...
  models: {
    ...
    providerEditorLoadFailed: 'Falha ao carregar as configuracoes do provedor',
    providerEditorSaved: 'Configuracoes do provedor salvas',
    providerEditorSaveFailed: 'Falha ao salvar as configuracoes do provedor',
    providerEditorConflict: 'Este provedor foi alterado em outro lugar. As configuracoes mais recentes foram recarregadas.',
    providerEditorRequired: 'Nome de exibicao, Base URL e modelo preferido sao obrigatorios.',
    providerInternalId: 'ID interno do provedor',
    providerDisplayName: 'Nome de exibicao',
    providerIdStableHint: 'O ID interno do provedor permanece inalterado para que as referencias existentes continuem validas.',
    providerPreferredModel: 'Modelo preferido do provedor',
    providerPreferredModelHint: 'Isto nao altera o modelo padrao de todo o perfil.',
    selectOrEnterModel: 'Selecione ou insira um ID de modelo...',
    unverifiedModelWarning: 'Este modelo nao esta no catalogo atual e nao foi verificado.',
    credentialConfigured: 'Configurado',
    credentialNotConfigured: 'Nao configurado',
    leaveBlankKeepCredential: 'Deixe em branco para manter a chave atual',
    enterCredential: 'Insira a credencial do provedor',
    credentialNeverDisplayedHint: 'A chave armazenada nunca e exibida. Insira um novo valor apenas para substitui-la.',
    providerCredentialMissingHint: 'Este provedor fica indisponivel ate que uma credencial seja configurada.',
    providerAdvancedSettings: 'Configuracoes avancadas do provedor',
    discoverModels: 'Descobrir modelos do provedor',
    rateLimitDelay: 'Atraso de limite de taxa (segundos)',
    requestTimeoutSeconds: 'Tempo limite de solicitacao (segundos)',
    staleTimeoutSeconds: 'Tempo limite de solicitacoes obsoletas (segundos)',
    extraBodyHint: 'Objeto JSON opcional mesclado nas solicitacoes do provedor. Deixe em branco para remove-lo.',
    extraBodyInvalid: 'extra_body deve ser um objeto JSON valido.',
    providerTestUnsupported: 'O teste de conexao nao e compativel com este modo de API.',
    perModelContextLengths: 'Comprimentos de contexto por modelo',
    contextLengthInheritHint: 'Limpe um valor para herdar o padrao do provedor ou do sistema.',
    inheritDefault: 'Herdar padrao',
    providerReconnectHint: 'As alteracoes se aplicam a novas execucoes. Sessoes de chat ou de agente de codigo existentes precisam reconectar.',
    testConnection: 'Testar conexao',
    providerTestSuccess: 'Conexao bem-sucedida; {count} modelos encontrados',
    providerTestFailed: 'O teste de conexao do provedor falhou',
    providerTestFailedTitle: 'O teste de conexao falhou',
    providerSaveAnywayHint: 'Voce ainda pode salvar estas configuracoes explicitamente, mas o provedor pode ficar indisponivel.',
    saveAnyway: 'Salvar mesmo assim',
    providerCredentialsCleared: 'Credenciais do provedor removidas',
    clearProviderCredentials: 'Remover credenciais',
    clearCredentialsConfirm: 'Limpar as credenciais armazenadas de “{name}”? Este provedor integrado permanecera listado e podera ser usado novamente apos configurar as credenciais.',
  ...
  files: {
    ...
    previewFailed: 'Prévia indisponível',
    pdfPageLimit: 'Somente as primeiras {count} páginas são exibidas.',
    htmlPreviewTitle: 'Prévia HTML isolada',
    previewMode: 'Prévia',
    sourceMode: 'Código-fonte',
    tableMode: 'Tabela',
    worksheet: 'Planilha',
