export default {
  ...
  runtimeVersions: {
    ...
    activateSuccess: '版本选择已保存，重启 Envclaw 后生效。',
    jobStatus: {
      queued: '排队中',
      running: '下载中',
      completed: '已完成',
  ...
  jobs: {
    ...
    sortByName: '名称',
    sortByTime: '时间',
    sortByNameHint: '按名称排序',
    sortByTimeHint: '按时间排序',
    sortAsc: '升序',
    sortDesc: '降序',
    createJob: '创建任务',
    editJob: '编辑任务',
    ...
    scheduleCronFormat: '格式: 分 时 日 月 周',
    scheduleEveryNHoursAtMinute: '每 {n} 小时的 {minute} 分',
    scheduleMinuteOffset: '执行分钟',
    prompt: '提示词',
  ...
  envclaw: {
    ...
    platforms: {
      ...
      platformUrl: '平台地址',
      url: '官网地址',
      urlHint: '平台的网址，例如 https://example.com',
      config: '配置',
      ...
      cookie: 'Cookie',
      credentialHint: '请输入明文凭据',
      credentialNote: '凭据将以明文形式保存，用于生成提示词交给大模型执行任务',
      connected: '已连接',
      expired: '已过期',
      error: '异常',
    ...
    wizard: {
      ...
      deliverHint: '选择推送渠道，任务运行结果将尝试推送到所选频道',
      deliverPlaceholder: '选择推送平台',
      optionalSkills: '可选技能',
      skillOptional: '（来自平台配置）',
      skillHint: '选择平台后，平台已配置的技能会列在此处',
      selectSkillPlaceholder: '请选择技能…',
      noPlatformSkills: '当前平台暂无配置技能',
      platformBuiltinSkills: '平台自带技能（不可删除）',
      extraSkill: '额外技能（可选）',
      fromPlatform: '平台',
      ...
      comingSoon: '即将推出',
      // AI 引导对话
      aiWelcome: '你好！我是数据播报助手 🤖\n我可以帮你快速创建数据播报任务，只需几个简单的问题。\n\n准备好了吗？让我们开始吧！',
      aiAskPlatform: '首先，请选择你要访问的数据平台（可多选）：',
      aiAskFunction: '好的！接下来选择你需要的功能（可多选）：',
      aiAskSchedule: '你希望任务在什么时间执行？',
      aiAskTaskName: '最后一步！给这个任务起个名字吧：',
      aiNoPlatform: '⚠️ 暂未检测到已配置的数据平台。请先在「平台管理」中添加平台后再试。',
      aiNoFunction: '该平台暂未配置具体功能，我将跳过此步骤继续。',
      aiSkipFunction: '暂不选择功能',
      aiConfirmSelect: '确认选择',
      aiScheduleEveryday8: '每天早上 8:00',
      aiScheduleEveryday9: '每天早上 9:00',
      aiScheduleEveryday18: '每天下午 18:00',
      aiScheduleWeekday8: '工作日早上 8:00',
      aiScheduleMonday8: '每周一早上 8:00',
      aiSummaryTitle: '📋 **任务创建摘要**',
      aiSummaryName: '• **任务名称**：{name}',
      aiSummaryPlatform: '• **数据平台**：{platforms}',
      aiSummaryFunction: '• **执行功能**：{functions}',
      aiSummarySchedule: '• **执行时间**：{schedule}',
      aiSummaryPrompt: '• **提示词预览**：{prompt}...',
      aiSummaryConfirm: '确认创建这个任务吗？',
      aiConfirmCreate: '✅ 确认创建',
      aiRestart: '🔄 重新开始',
      aiSuccess: '🎉 任务创建成功！\n\n你可以在「任务管理」页面查看和编辑这个任务。需要创建新任务的话，点击下方按钮重新开始。',
      aiFailed: '❌ 创建失败：{error}\n\n请稍后重试或联系管理员。',
      aiCreateNew: '创建新任务',
      aiInputPlaceholder: '输入任务名称...',
      aiSelected: '我选择：{items}',
      aiSend: '发送',
    },
  },
