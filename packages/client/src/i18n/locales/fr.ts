export default {
  ...
  runtimeVersions: {
    ...
    activateSuccess: 'Sélection de version enregistrée. Redémarrez Envclaw pour l’utiliser.',
    jobStatus: {
      queued: 'En attente',
      running: 'En cours',
      completed: 'Terminé',
  ...
  jobs: {
    ...
    sortByTimeHint: 'Trier par heure',
    sortAsc: 'Croissant',
    ...
    scheduleCustomCron: 'Cron personnalisé',
    scheduleCronFormat: 'Format : minute heure jour mois jour_semaine',
    scheduleEveryNHoursAtMinute: 'Toutes les {n} heures à {minute} min',
    scheduleMinuteOffset: 'Minute de décalage',
...
jobTriggered: 'Job declenche',
  ...
  models: {
    ...
    providerEditorLoadFailed: 'Echec du chargement des parametres du fournisseur',
    providerEditorSaved: 'Parametres du fournisseur enregistres',
    providerEditorSaveFailed: 'Echec de l enregistrement des parametres du fournisseur',
    providerEditorConflict: 'Ce fournisseur a ete modifie ailleurs. Les parametres les plus recents ont ete recharges.',
    providerEditorRequired: 'Le nom affiche, la Base URL et le modele prefere sont obligatoires.',
    providerInternalId: 'ID interne du fournisseur',
    providerDisplayName: 'Nom affiche',
    providerIdStableHint: 'L ID interne du fournisseur reste inchange afin que les references existantes restent valides.',
    providerPreferredModel: 'Modele prefere du fournisseur',
    providerPreferredModelHint: 'Ceci ne modifie pas le modele par defaut de tout le profil.',
    selectOrEnterModel: 'Selectionnez ou saisissez un ID de modele...',
    unverifiedModelWarning: 'Ce modele n est pas dans le catalogue actuel et n a pas ete verifie.',
    credentialConfigured: 'Configure',
    credentialNotConfigured: 'Non configure',
    leaveBlankKeepCredential: 'Laissez vide pour conserver la cle actuelle',
    enterCredential: 'Saisissez les identifiants du fournisseur',
    credentialNeverDisplayedHint: 'La cle enregistree n est jamais affichee. Saisissez une nouvelle valeur uniquement pour la remplacer.',
    providerCredentialMissingHint: 'Ce fournisseur est indisponible tant qu un identifiant n est pas configure.',
    providerAdvancedSettings: 'Parametres avances du fournisseur',
    discoverModels: 'Decouvrir les modeles depuis le fournisseur',
    rateLimitDelay: 'Delai de limitation de debit (secondes)',
    requestTimeoutSeconds: 'Delai d expiration de la requete (secondes)',
    staleTimeoutSeconds: 'Delai d expiration des requetes obsoletes (secondes)',
    extraBodyHint: 'Objet JSON optionnel fusionne dans les requetes du fournisseur. Laissez vide pour le supprimer.',
    extraBodyInvalid: 'extra_body doit etre un objet JSON valide.',
    providerTestUnsupported: 'Le test de connexion n est pas pris en charge pour ce mode d API.',
    perModelContextLengths: 'Longueurs de contexte par modele',
    contextLengthInheritHint: 'Effacez une valeur pour heriter de la valeur par defaut du fournisseur ou du systeme.',
    inheritDefault: 'Heriter par defaut',
    providerReconnectHint: 'Les modifications s appliquent aux nouvelles executions. Les sessions de chat ou d agent de code existantes doivent se reconnecter.',
    testConnection: 'Tester la connexion',
    providerTestSuccess: 'Connexion reussie ; {count} modeles trouves',
    providerTestFailed: 'Le test de connexion du fournisseur a echoue',
    providerTestFailedTitle: 'Le test de connexion a echoue',
    providerSaveAnywayHint: 'Vous pouvez toujours enregistrer ces parametres explicitement, mais le fournisseur peut etre indisponible.',
    ...
    clearCredentialsConfirm: 'Effacer les identifiants enregistres de « {name} » ? Ce fournisseur integre reste repertorie et peut etre reutilise une fois les identifiants configures.',
  ...
  files: {
    ...
    htmlPreviewTitle: 'Aperçu HTML isolé',
    previewMode: 'Aperçu',
    sourceMode: 'Source',
    tableMode: 'Tableau',
    worksheet: 'Feuille',
