export default {
  ...
  jobs: {
    ...
    sortByName: '名稱',
    sortByTime: '時間',
    sortByNameHint: '按名稱排序',
    sortByTimeHint: '按時間排序',
    sortAsc: '升序',
    sortDesc: '降序',
    createJob: '建立任務',
    editJob: '編輯任務',
  ...
  models: {
    ...
    providerEditorConflict: '該 Provider 已被其他操作修改，現已重新載入最新設定。',
    providerEditorRequired: '顯示名稱、Base URL 和偏好模型不能為空。',
    providerInternalId: 'Provider 內部 ID',
    providerDisplayName: '顯示名稱',
    providerIdStableHint: '內部 Provider ID 保持不變，既有參照不會失效。',
    providerPreferredModel: 'Provider 偏好模型',
    ...
    providerCredentialMissingHint: '該 Provider 現已無法運行，重新設定憑證後才能使用。',
    ...
    extraBodyHint: '可選 JSON 物件，會合併到 Provider 請求體；留空表示移除。',
    extraBodyInvalid: 'extra_body 必須是有效的 JSON 物件。',
    providerTestUnsupported: '目前 API Mode 不支援連線測試。',
    perModelContextLengths: '逐模型上下文長度',
    contextLengthInheritHint: '清空數值即繼承 Provider 或系統預設值。',
    inheritDefault: '繼承預設值',
    providerReconnectHint: '修改只對新執行生效；既有聊天或 Coding Agent 工作階段需要重新連線。',
    testConnection: '測試連線',
    ...
    saveAnyway: '仍然儲存',
    providerCredentialsCleared: 'Provider 憑證已清除',
    clearProviderCredentials: '清除憑證',
    clearCredentialsConfirm: '確定清除「{name}」的已儲存憑證嗎？這是內建 Provider，項目會繼續顯示，重新設定憑證後仍可使用。',
