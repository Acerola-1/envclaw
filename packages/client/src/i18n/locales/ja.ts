export default {
  ...
  runtimeVersions: {
    ...
    activateSuccess: 'バージョン選択を保存しました。Envclaw を再起動すると反映されます。',
    jobStatus: {
      queued: '待機中',
      running: '実行中',
      completed: '完了',
  ...
  jobs: {
    ...
    sortByName: '名前',
    sortByTime: '時間',
    sortByNameHint: '名前で並び替え',
    sortByTimeHint: '時間で並び替え',
    sortAsc: '昇順',
    sortDesc: '降順',
    createJob: 'ジョブを作成',
    editJob: 'ジョブを編集',
  ...
  models: {
    ...
    providerEditorLoadFailed: 'プロバイダー設定の読み込みに失敗しました',
    providerEditorSaved: 'プロバイダー設定を保存しました',
    providerEditorSaveFailed: 'プロバイダー設定の保存に失敗しました',
    providerEditorConflict: 'このプロバイダーは別の操作で変更されました。最新の設定を再読み込みしました。',
    providerEditorRequired: '表示名、Base URL、優先モデルは必須です。',
    providerInternalId: 'プロバイダー内部 ID',
    providerDisplayName: '表示名',
    providerIdStableHint: '内部プロバイダー ID は変更されないため、既存の参照は有効なままです。',
    providerPreferredModel: 'プロバイダーの優先モデル',
    providerPreferredModelHint: 'これはプロファイル全体の既定モデルを変更しません。',
    selectOrEnterModel: 'モデル ID を選択または入力...',
    unverifiedModelWarning: 'このモデルは現在のカタログになく、検証されていません。',
    credentialConfigured: '設定済み',
    credentialNotConfigured: '未設定',
    leaveBlankKeepCredential: '空欄のままにすると現在のキーを保持します',
    enterCredential: 'プロバイダーの資格情報を入力',
    credentialNeverDisplayedHint: '保存されたキーは表示されません。置き換える場合のみ新しい値を入力してください。',
    providerCredentialMissingHint: 'このプロバイダーは資格情報が設定されるまで利用できません。',
    providerAdvancedSettings: 'プロバイダーの詳細設定',
    discoverModels: 'プロバイダーからモデルを検出する',
    rateLimitDelay: 'レート制限の遅延（秒）',
    requestTimeoutSeconds: 'リクエストタイムアウト（秒）',
    staleTimeoutSeconds: '古いリクエストのタイムアウト（秒）',
    extraBodyHint: 'プロバイダーのリクエストにマージされる任意の JSON オブジェクト。空欄にすると削除されます。',
    extraBodyInvalid: 'extra_body は有効な JSON オブジェクトである必要があります。',
    providerTestUnsupported: 'この API モードでは接続テストはサポートされていません。',
    perModelContextLengths: 'モデルごとのコンテキスト長',
    contextLengthInheritHint: '値をクリアすると、プロバイダーまたはシステムの既定値を継承します。',
    inheritDefault: '既定値を継承',
    providerReconnectHint: '変更は新しい実行に適用されます。既存のチャットまたは Coding Agent セッションは再接続が必要です。',
    testConnection: '接続をテスト',
    providerTestSuccess: '接続に成功しました。{count} 個のモデルが見つかりました',
    providerTestFailed: 'プロバイダーの接続テストに失敗しました',
    providerTestFailedTitle: '接続テストに失敗しました',
    providerSaveAnywayHint: 'これらの設定を明示的に保存することはできますが、プロバイダーが利用できない可能性があります。',
    saveAnyway: 'それでも保存',
    providerCredentialsCleared: 'プロバイダーの資格情報を消去しました',
    clearProviderCredentials: '資格情報を消去',
    clearCredentialsConfirm: '「{name}」に保存されている資格情報を消去しますか？この組み込みプロバイダーは一覧に残り、資格情報を再設定すれば再び使用できます。',
  ...
  files: {
    ...
    closePreview: '閉じる',
    previewLoading: 'プレビュー を読み込み中...',
    previewFailed: 'プレビューできません',
    pdfPageLimit: '先頭の {count} ページのみ表示します。',
    htmlPreviewTitle: '分離された HTML プレビュー',
    previewMode: 'プレビュー',
    sourceMode: 'ソース',
    tableMode: '表',
    worksheet: 'ワークシート',
