export default {
  ...
  jobs: {
    ...
    sortByName: 'Name',
    sortByTime: 'Time',
    sortByNameHint: 'Sort by name',
    sortByTimeHint: 'Sort by time',
    sortAsc: 'Ascending',
    sortDesc: 'Descending',
    ...
    scheduleCronFormat: 'Format: minute hour day month weekday',
    scheduleEveryNHoursAtMinute: 'Every {n} hours at {minute} min',
    scheduleMinuteOffset: 'Minute offset',
    prompt: 'Prompt',
  ...
  envclaw: {
    ...
    home: {
      ...
      stats: {
        ...
        todayCollection: 'Today\'s Data Collection',
        allNormal: 'All running normally',
        vsYesterday: '{diff} vs yesterday',
        pending: 'Pending',
        noData: 'No data source connected',
      },
      scenarios: {
        title: 'Scenarios',
        hint: 'Choose a scenario and the system will guide you through setup',
        start: 'Start',
      ...
      tasks: {
        ...
        lastRun: 'Last {time}',
        nextRun: 'Next {time}',
        triggerToday: '{n} triggers today',
      },
      platforms: {
        title: 'Platform Management',
        hint: 'Configure once, auto-login',
        manage: 'Manage',
    ...
    platforms: {
      title: 'Platform Management',
      description: 'Manage data platform credentials, operation knowledge, skills, and functions',
      addPlatform: 'Add Platform',
      editPlatform: 'Edit Platform',
      deletePlatform: 'Delete Platform',
      deleteConfirm: 'Are you sure you want to delete platform "{name}"? All accounts and function configurations will be removed.',
      type: 'Platform Type',
      platformName: 'Platform Name',
      platformUrl: 'Platform URL',
      url: 'Website URL',
      urlHint: 'The platform website URL, e.g. https://example.com',
      config: 'Config',
      operationPrompt: 'Operation Prompt',
      operationPromptHint: 'Describe how to log in and operate this platform',
      platformSkills: 'Platform Skills',
      platformSkillsHint: 'Skills for this platform, automatically included when creating tasks',
      functions: 'Functions',
      addFunction: 'Add Function',
      functionName: 'Function Name',
      functionPrompt: 'Function Prompt',
      functionPromptHint: 'Describe how to find and operate this function',
      ...
      cookie: 'Cookie',
      credentialHint: 'Please enter credentials in plain text',
      credentialNote: 'Credentials will be saved in plain text and used to generate prompts for AI task execution',
      connected: 'Connected',
      expired: 'Expired',
      error: 'Error',
      noPlatforms: 'No platforms yet. Click the button above to add one.',
      configNote: 'Only platform-level configuration here. Accounts are managed on the platform card.',
      types: {
        mapairs: 'MapAirs',
        national_station: 'National Station',
        oa: 'OA System',
        feishu: 'Feishu',
        dingtalk: 'DingTalk',
        custom: 'Custom',
    ...
    wizard: {
      ...
      multiSelectPlatform: '(multi-select)',
      ...
      deliverHint: 'Select delivery channels, task results will be pushed to selected channels',
      deliverPlaceholder: 'Select deliver platform',
      optionalSkills: 'Optional Skills',
      skillOptional: '(from platform config)',
      skillHint: 'Platform skills will appear here after selecting a platform',
      selectSkillPlaceholder: 'Select a skill…',
      noPlatformSkills: 'No skills configured for this platform',
      platformBuiltinSkills: 'Platform Built-in Skills (cannot be removed)',
      extraSkill: 'Extra Skill (optional)',
      ...
      comingSoon: 'Coming Soon',
      // AI Guide Chat
      aiWelcome: 'Hello! I\'m the Data Broadcast Assistant 🤖\nI can help you quickly create a data broadcast task with just a few simple questions.\n\nReady? Let\'s get started!',
      aiAskPlatform: 'First, please select the data platform(s) you want to access (multi-select):',
      aiAskFunction: 'Great! Now select the functions you need (multi-select):',
      aiAskSchedule: 'When would you like the task to run?',
      aiAskTaskName: 'Last step! Give this task a name:',
      aiNoPlatform: '⚠️ No configured data platforms detected. Please add a platform in "Platform Management" first.',
      aiNoFunction: 'This platform has no configured functions. I\'ll skip this step.',
      aiSkipFunction: 'Skip functions',
      aiConfirmSelect: 'Confirm Selection',
      aiScheduleEveryday8: 'Every day at 8:00 AM',
      aiScheduleEveryday9: 'Every day at 9:00 AM',
      aiScheduleEveryday18: 'Every day at 6:00 PM',
      aiScheduleWeekday8: 'Weekdays at 8:00 AM',
      aiScheduleMonday8: 'Every Monday at 8:00 AM',
      aiSummaryTitle: '📋 **Task Creation Summary**',
      aiSummaryName: '• **Task Name**: {name}',
      aiSummaryPlatform: '• **Data Platform**: {platforms}',
      aiSummaryFunction: '• **Functions**: {functions}',
      aiSummarySchedule: '• **Execution Time**: {schedule}',
      aiSummaryPrompt: '• **Prompt Preview**: {prompt}...',
      aiSummaryConfirm: 'Confirm creating this task?',
      aiConfirmCreate: '✅ Confirm Create',
      aiRestart: '🔄 Start Over',
      aiSuccess: '🎉 Task created successfully!\n\nYou can view and edit this task in "Task Management". Click the button below to create a new task.',
      aiFailed: '❌ Creation failed: {error}\n\nPlease try again later or contact the administrator.',
      aiCreateNew: 'Create New Task',
      aiInputPlaceholder: 'Enter task name...',
      aiSelected: 'I selected: {items}',
      aiSend: 'Send',
    },
  },
