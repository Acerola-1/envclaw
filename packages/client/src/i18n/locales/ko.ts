export default {
  ...
  jobs: {
    ...
    sortByName: '이름',
    sortByTime: '시간',
    sortByNameHint: '이름순 정렬',
    sortByTimeHint: '시간순 정렬',
    sortAsc: '오름차순',
    sortDesc: '내림차순',
    createJob: '작업 생성',
    editJob: '작업 편집',
    ...
    scheduleWeekly: '매주',
    scheduleMonthly: '매월',
    scheduleCustom: '사용자 정의',
    scheduleCustomCron: '사용자 정의 Cron',
    scheduleCronFormat: '형식: 분 시 일 월 요일',
    scheduleEveryNHoursAtMinute: '{n}시간마다 {minute}분에',
    scheduleMinuteOffset: '분 오프셋',
  ...
  models: {
    ...
    editProviderTitle: '{name} 편집',
    providerEditorLoadFailed: '프로바이더 설정을 불러오지 못했습니다',
    providerEditorSaved: '프로바이더 설정이 저장되었습니다',
    providerEditorSaveFailed: '프로바이더 설정을 저장하지 못했습니다',
    providerEditorConflict: '이 프로바이더가 다른 곳에서 변경되었습니다. 최신 설정을 다시 불러왔습니다.',
    providerEditorRequired: '표시 이름, Base URL, 선호 모델은 필수입니다.',
    providerInternalId: '내부 프로바이더 ID',
    providerDisplayName: '표시 이름',
    providerIdStableHint: '내부 프로바이더 ID는 변경되지 않으므로 기존 참조가 계속 유효합니다.',
    providerPreferredModel: '프로바이더 선호 모델',
    providerPreferredModelHint: '이 설정은 프로필 전체의 기본 모델을 변경하지 않습니다.',
    selectOrEnterModel: '모델 ID를 선택하거나 입력하세요...',
    unverifiedModelWarning: '이 모델은 현재 카탈로그에 없으며 검증되지 않았습니다.',
    credentialConfigured: '구성됨',
    credentialNotConfigured: '구성되지 않음',
    leaveBlankKeepCredential: '비워 두면 현재 키를 유지합니다',
    enterCredential: '프로바이더 자격 증명을 입력하세요',
    credentialNeverDisplayedHint: '저장된 키는 표시되지 않습니다. 교체할 때만 새 값을 입력하세요.',
    providerCredentialMissingHint: '이 프로바이더는 자격 증명이 구성될 때까지 사용할 수 없습니다.',
    providerAdvancedSettings: '프로바이더 고급 설정',
    discoverModels: '프로바이더에서 모델 검색',
    rateLimitDelay: '속도 제한 지연(초)',
    requestTimeoutSeconds: '요청 시간 초과(초)',
    staleTimeoutSeconds: '오래된 요청 시간 초과(초)',
    extraBodyHint: '프로바이더 요청에 병합되는 선택적 JSON 객체입니다. 비워 두면 제거됩니다.',
    extraBodyInvalid: 'extra_body는 유효한 JSON 객체여야 합니다.',
    providerTestUnsupported: '이 API 모드에서는 연결 테스트가 지원되지 않습니다.',
    perModelContextLengths: '모델별 컨텍스트 길이',
    contextLengthInheritHint: '값을 지우면 프로바이더 또는 시스템 기본값을 상속합니다.',
    inheritDefault: '기본값 상속',
    providerReconnectHint: '변경 사항은 새 실행에 적용됩니다. 기존 채팅 또는 Coding Agent 세션은 다시 연결해야 합니다.',
    testConnection: '연결 테스트',
    providerTestSuccess: '연결 성공, {count}개 모델을 찾았습니다',
    providerTestFailed: '프로바이더 연결 테스트 실패',
    providerTestFailedTitle: '연결 테스트 실패',
    providerSaveAnywayHint: '이 설정을 명시적으로 저장할 수 있지만 프로바이더를 사용할 수 없을 수 있습니다.',
    saveAnyway: '그래도 저장',
    providerCredentialsCleared: '프로바이더 자격 증명이 삭제되었습니다',
    clearProviderCredentials: '자격 증명 삭제',
    clearCredentialsConfirm: '“{name}”에 저장된 자격 증명을 삭제할까요? 이 기본 제공 프로바이더는 목록에 유지되며 자격 증명을 다시 구성하면 사용할 수 있습니다.',
  ...
  files: {
    ...
    previewFailed: '미리보기를 사용할 수 없음',
    pdfPageLimit: '처음 {count}페이지만 표시합니다.',
    htmlPreviewTitle: '격리된 HTML 미리보기',
    previewMode: '미리보기',
    sourceMode: '소스',
    tableMode: '표',
    worksheet: '워크시트',
    previousPage: '이전',
    nextPage: '다음',
    pageStatus: '{total}페이지 중 {page}페이지',
    zoom: '확대/축소',
